...
export default function Header() {
    ...
    const [Menu, setMenu] = useState([
        { id: 1, title: 'صفحه اصلی', logoId: '#home' },
        {
            id: 2, title: 'فروشگاه', logoId: '#shopping-bag', subMenu: [
                { id: 1, title: 'قهوه ویژه' },
                { id: 2, title: 'ویژه در سطح جهانی' },
                { id: 3, title: 'قهوه درجه یک' },
                { id: 4, title: 'کپسول قهوه' },
                { id: 5, title: 'قهوه زینو برزیلی' }
            ]
        },
        { id: 3, title: 'دیکشنری', logoId: '#chat' },
        { id: 4, title: 'درباره ما', logoId: '#briefCase' },
        { id: 5, title: 'بلاگ', logoId: '#blog' },
        { id: 5, title: 'تماس با ما', logoId: '#phone' }
        ...
        <>
            ...
            <header className="hidden w-[90%] mx-auto bg-black/50 md:flex justify-between items-center rounded-3xl text-xl py-5 px-3.5 lg:px-10  ">
                <svg className="hidden">
                    ...
                    <symbol id="bars3" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
                    ...
                    <symbol id='logo' width="41" height="40" viewBox="0 0 41 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <symbol id='shopping-bag' xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
                    ...
                    <symbol id="blog" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" >
