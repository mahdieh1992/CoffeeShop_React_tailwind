...
export default function Header() {
    return (
        <header className=" w-[90%] bg-black/50 mx-auto  hidden md:flex justify-between items-center rounded-3xl text-xl py-5 px-3.5 lg:px-10 mt-9 ">
           ...
           <nav className="flex gap-x-3 lg:gap-x-9 items-center">
            {/* Logo icon */}
             <div>
              ...
              {/* Menu */}
             <ul className="flex  gap-x-3 lg:gap-x-9  text-gray-300 font-DanaRegular tracking-tightest">
                <li>صفحه اصلی</li>
                <li>فروشگاه</li>
                <li>دیکشنری</li>
                <li>بلاگ</li>
           ...
           {/* icon & login */}
           <div className="flex items-center gap-x-2.5 lg:gap-x-5 text-orange-200">
            {/* icons */}
